...
export const NDA_STANDARD_TERMS: NdaClause[] = [
  {
    title: "Introduction",
  ...
  },
  {
    ...
    body: "This MNDA commences on the {{EFFECTIVE_DATE}} and, unless earlier terminated, remains in effect for {{MNDA_TERM}}. Either party may terminate this MNDA for any or no reason upon written notice to the other party. The Receiving Party’s obligations relating to Confidential Information will survive for {{CONFIDENTIALITY_TERM}}, despite any expiration or termination of this MNDA.",
  },
  {
...
export const NDA_SOURCE_ATTRIBUTION =
  "Adapted from the Common Paper Mutual Non-Disclosure Agreement, Version 1.0 (commonpaper.com/standards/mutual-nda/1.0), used under CC BY 4.0.";
